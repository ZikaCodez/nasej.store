...
// Raw areas (cities/districts) keyed by governorate_id
const RAW_AREAS: Array<{
  id: string;
  governorate_id: string;
  city_name_en: string;
  city_name_ar: string;
  ...
  { id: "35", governorate_id: "1", city_name_ar: "طره", city_name_en: "Tura" },
  {
    id: "36",
    governorate_id: "1",
    city_name_ar: "عابدين",
  ...
  { id: "63", governorate_id: "2", city_name_ar: "الصف", city_name_en: "Saf" },
  {
    id: "64",
    governorate_id: "2",
    city_name_ar: "أطفيح",
  ...
  { id: "141", governorate_id: "4", city_name_ar: "أجا", city_name_en: "Aga" },
  {
    id: "142",
    governorate_id: "4",
  ...
  { id: "177", governorate_id: "6", city_name_ar: "بدر", city_name_en: "Badr" },
  {
    id: "178",
    governorate_id: "6",
...
export const AREAS: Area[] = RAW_AREAS.map((a) => ({
  id: a.id,
  governorate_id: a.governorate_id,
  name_en: a.city_name_en,
  name_ar: a.city_name_ar,
  label: `${a.city_name_en} - ${a.city_name_ar}`,
}));

export const GOVERNORATES: Omit<Governorate, "areas">[] = RAW_GOVERNORATES.map(
  (g) => ({
    id: g.id,
    name_en: g.governorate_name_en,
    name_ar: g.governorate_name_ar,
    label: `${g.governorate_name_en} - ${g.governorate_name_ar}`,
  }),
);

export const GOVERNORATES_WITH_AREAS: Governorate[] = GOVERNORATES.map((g) => ({
  ...g,
  areas: AREAS.filter((a) => a.governorate_id === g.id),
}));

export function getGovernorateByEnglishName(nameEn?: string) {
  if (!nameEn) return undefined;
  return GOVERNORATES_WITH_AREAS.find((g) => g.name_en === nameEn);
}

export function getAreaByEnglishName(nameEn?: string) {
  if (!nameEn) return undefined;
  return AREAS.find((a) => a.name_en === nameEn);
}
